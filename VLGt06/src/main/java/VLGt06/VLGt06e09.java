...
public class VLGt06e09 {
    ...
    public static void a() {
        ...
        try {
            ...
            System.out.println("Han pasado " + ((new Date().getTime() - fecha.getTime()) / 1000 / 60 / 60 / 24 ) + " dias desde tu nacimiento.");
    ...
    public static void b(){
        ...
        try {
            ...
            fecha.setTime(fecha.getTime() + (long) dias * 1000 * 60 * 60 * 24);
    ...
    public static void d(){
        ...
        for (int i = 0; i < 2024; i++) {
            ...
            if (fecha.getYear() % 4 == 0 && (fecha.getYear() % 100 != 0 || fecha.getYear() % 400 == 0)) {
                System.out.println(fecha.getYear() + " es bisiesto.");
            }
        }
    }
